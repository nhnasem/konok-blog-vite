...
const AddPostForm = () => {
  ...
  return (
    <section className="border px-4 py-3 w-[700px] shadow-md mx-auto my-4">
      <h2 className="text-2xl text-center my-3 leading-8 tracking-wide font-light">
        Add a New Post
      </h2>
      <form className="flex-row">
        <div className="flex flex-col items-start mb-4">
          <label
            className="text-sm font-light leading-8 tracking-wide"
            htmlFor="postTitle"
          >
            Post Title:
          </label>
        ...
        <div className="mb-4">
          <h2 className="text-sm font-light leading-8 tracking-wide">
            Post body:
          </h2>
          <CKEditor
